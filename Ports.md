...
547:DHCPv6 client sends a Solicit from [fe80::aabb:ccff:fedd:eeff]:546 for [ff02::1:2]:547

5353:Multicats dns -FF02::FB. UDP port 5353.
3702:The multicast address used is 239.255.255.250 on IPV4 networks and [FF02::C] on IPV6 networks. In both cases, multicast messages are sent to port 3702
...
# (due to a bug in exampled the 3com-tsmux line is disabled)
