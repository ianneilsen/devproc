...
# chown apache:developers test.php Change ownership of test.php to “apache”
...
and write it
2# chown -R :developers /var/www/html Change ownership of /var/www/html and
